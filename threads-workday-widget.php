...
class Threads_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$build_ics = <<<HTML
<form style="display: inline" method="post" name="build-ics" action="$ics_file">
...
function register_threads_widget() {
	register_widget( 'Threads_Widget' );
}
add_action( 'widgets_init', 'register_threads_widget' );
